...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"ui six link cards"], null),(function (){var iter__4292__auto__ = (function glurps$component$card$card$cards_html_$_iter__51811(s__51812){
return (new cljs.core.LazySeq(null,(function (){
var s__51812__$1 = s__51812;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__51812__$1);
if(temp__5457__auto__){
var s__51812__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__51812__$2)){
var c__4290__auto__ = cljs.core.chunk_first.call(null,s__51812__$2);
var size__4291__auto__ = cljs.core.count.call(null,c__4290__auto__);
var b__51814 = cljs.core.chunk_buffer.call(null,size__4291__auto__);
if((function (){var i__51813 = (0);
while(true){
if((i__51813 < size__4291__auto__)){
var record = cljs.core._nth.call(null,c__4290__auto__,i__51813);
cljs.core.chunk_append.call(null,b__51814,glurps.component.card.card.card_html.call(null,new cljs.core.Keyword(null,"image","image",-58725096).cljs$core$IFn$_invoke$arity$1(record),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(record),new cljs.core.Keyword(null,"meta","meta",1499536964).cljs$core$IFn$_invoke$arity$1(record),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(record)));

var G__51815 = (i__51813 + (1));
i__51813 = G__51815;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__51814),glurps$component$card$card$cards_html_$_iter__51811.call(null,cljs.core.chunk_rest.call(null,s__51812__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__51814),null);
}
} else {
var record = cljs.core.first.call(null,s__51812__$2);
return cljs.core.cons.call(null,glurps.component.card.card.card_html.call(null,new cljs.core.Keyword(null,"image","image",-58725096).cljs$core$IFn$_invoke$arity$1(record),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(record),new cljs.core.Keyword(null,"meta","meta",1499536964).cljs$core$IFn$_invoke$arity$1(record),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(record)),glurps$component$card$card$cards_html_$_iter__51811.call(null,cljs.core.rest.call(null,s__51812__$2)));
}
} else {
return null;
}
