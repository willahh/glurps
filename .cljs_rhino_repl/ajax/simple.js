...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__44237){
...
var handler = cljs.core.get.call(null,map__44238__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return (function (p1__44240_SHARP_){
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3922__auto__ = p1__44240_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__44241){
var map__44242 = p__44241;
var map__44242__$1 = ((((!((map__44242 == null)))?(((((map__44242.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44242.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44242):map__44242);
var request = map__44242__$1;
var interceptors = cljs.core.get.call(null,map__44242__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
