...
var G__21860 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21860;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__21861 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21861,ch);
...
if(("\\" === ch__$1)){
var ch_21862__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_21862__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_21862__$2);
} else {
}
...
var start_line = cljs.core.nth.call(null,vec__21871,(0),null);
var start_column = cljs.core.nth.call(null,vec__21871,(1),null);
...
var G__21874 = cljs.core.conj_BANG_.call(null,a,form);
a = G__21874;
continue;
}
}
...
var _STAR_read_delim_STAR_21875 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_21875;
}});
/**
...
var start_line = cljs.core.nth.call(null,vec__21882,(0),null);
var start_column = cljs.core.nth.call(null,vec__21882,(1),null);
...
var vec__21885 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21885,(0),null);
var end_column = cljs.core.nth.call(null,vec__21885,(1),null);
...
var vec__21888 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21888,(0),null);
var start_column = cljs.core.nth.call(null,vec__21888,(1),null);
...
var vec__21891 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21891,(0),null);
var end_column = cljs.core.nth.call(null,vec__21891,(1),null);
...
var sb = (function (){var G__21894 = (new goog.string.StringBuffer());
G__21894.append(initch);
...
var G__21896 = (function (){var G__21895 = sb;
G__21895.append(ch);

return G__21895;
})();
var G__21897 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__21896;
ch = G__21897;
continue;
}
...
switch (G__21900) {
case "\\":
var G__21904 = (function (){var G__21901 = sb;
G__21901.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__21901;
})();
var G__21905 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21904;
ch = G__21905;
continue;
...
break;
default:
var G__21906 = (function (){var G__21902 = sb;
G__21902.append(ch);

return G__21902;
})();
var G__21907 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21906;
ch = G__21907;
continue;
...
var vec__21908 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21908,(0),null);
var end_column = cljs.core.nth.call(null,vec__21908,(1),null);
...
var line = cljs.core.nth.call(null,vec__21916,(0),null);
var column = cljs.core.nth.call(null,vec__21916,(1),null);
...
var line = cljs.core.nth.call(null,vec__21921,(0),null);
var column = cljs.core.nth.call(null,vec__21921,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__21926 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21926,(0),null);
var start_column = cljs.core.nth.call(null,vec__21926,(1),null);
...
var vec__21929 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21929,(0),null);
var end_column = cljs.core.nth.call(null,vec__21929,(1),null);
...
var G__21932 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__21932,true,null,opts,pending_forms);
...
var G__21933 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__21933)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__21933)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__21933)){
...
var _STAR_suppress_read_STAR_21934 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_21934;
}});
...
var G__21935 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__21935,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__21935,rdr,first_line);
...
var G__21939 = matched;
var G__21940 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__21939;
finished = G__21940;
continue;
} else {
...
var _STAR_suppress_read_STAR_21941 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_21941;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env21942 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__21943 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21943,"(");
...
var G__21944 = (i + (1));
var G__21945 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env21942;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__21946 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__21946);
...
var G__21949 = cljs.core.next.call(null,s);
var G__21950 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__21949;
key_vals = G__21950;
continue;
} else {
...
var gensym_env21954 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env21954;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__21955 = token;
var G__21955__$1 = (((G__21955 == null))?null:cljs.core.subs.call(null,G__21955,(1)));
var G__21955__$2 = (((G__21955__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__21955__$1));
var G__21955__$3 = (((G__21955__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__21955__$2));
var G__21955__$4 = (((G__21955__$3 == null))?null:cljs.core.symbol.call(null,G__21955__$3));
if((G__21955__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__21955__$4);
}
})():(function (){var G__21956 = token;
var G__21956__$1 = (((G__21956 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__21956));
if((G__21956__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__21956__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__21967,reader){
...
var eof = cljs.core.get.call(null,map__21968__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___21976 = arguments.length;
var i__4500__auto___21977 = (0);
while(true){
if((i__4500__auto___21977 < len__4499__auto___21976)){
args__4502__auto__.push((arguments[i__4500__auto___21977]));

var G__21978 = (i__4500__auto___21977 + (1));
i__4500__auto___21977 = G__21978;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq21974){
var G__21975 = cljs.core.first.call(null,seq21974);
var seq21974__$1 = cljs.core.next.call(null,seq21974);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21975,seq21974__$1);
});


//# sourceMappingURL=reader.js.map?rel=1525376036261
