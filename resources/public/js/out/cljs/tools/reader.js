...
var G__26023 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26023;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26024 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26024,ch);
...
if(("\\" === ch__$1)){
var ch_26025__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26025__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26025__$2);
} else {
}

var G__26026 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26026;
continue;
}
}
...
var vec__26034 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26034,(0),null);
var start_column = cljs.core.nth.call(null,vec__26034,(1),null);
...
var G__26037 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26037;
continue;
}
}
...
var _STAR_read_delim_STAR_26038 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_26038;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26039 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__26042 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26042,(0),null);
var end_column = cljs.core.nth.call(null,vec__26042,(1),null);
...
var vec__26045 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__26048 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26048,(0),null);
var end_column = cljs.core.nth.call(null,vec__26048,(1),null);
...
var vec__26051 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26051,(0),null);
var start_column = cljs.core.nth.call(null,vec__26051,(1),null);
...
var vec__26054 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26054,(0),null);
var end_column = cljs.core.nth.call(null,vec__26054,(1),null);
...
var sb = (function (){var G__26057 = (new goog.string.StringBuffer());
G__26057.append(initch);
...
var G__26059 = (function (){var G__26058 = sb;
G__26058.append(ch);
...
switch (G__26063) {
case "\\":
var G__26067 = (function (){var G__26064 = sb;
G__26064.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26064;
})();
var G__26068 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26067;
ch = G__26068;
continue;
...
break;
default:
var G__26069 = (function (){var G__26065 = sb;
G__26065.append(ch);

return G__26065;
})();
var G__26070 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26069;
ch = G__26070;
continue;
...
var vec__26071 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26071,(0),null);
var end_column = cljs.core.nth.call(null,vec__26071,(1),null);
...
var vec__26074 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26074,(0),null);
var column = cljs.core.nth.call(null,vec__26074,(1),null);
...
var vec__26079 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26079,(0),null);
var column = cljs.core.nth.call(null,vec__26079,(1),null);
...
var vec__26084 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26084,(0),null);
var column = cljs.core.nth.call(null,vec__26084,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26089 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26089,(0),null);
var start_column = cljs.core.nth.call(null,vec__26089,(1),null);
...
var vec__26092 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26092,(0),null);
var end_column = cljs.core.nth.call(null,vec__26092,(1),null);
...
var G__26095 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26095,true,null,opts,pending_forms);
...
var G__26096 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26096)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26096)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26096)){
...
var _STAR_suppress_read_STAR_26097 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26097;
}});
...
var G__26098 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26098,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26098,rdr,first_line);
...
var G__26102 = matched;
var G__26103 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26102;
finished = G__26103;
continue;
} else {
...
var _STAR_suppress_read_STAR_26104 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_26104;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env26105 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26106 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26106,"(");
...
var G__26107 = (i + (1));
var G__26108 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env26105;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26109 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26109);
...
var G__26110 = cljs.core.next.call(null,s__$1);
var G__26111 = ret;
s__$1 = G__26110;
r = G__26111;
continue;
...
var G__26112 = cljs.core.next.call(null,s);
var G__26113 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26112;
key_vals = G__26113;
continue;
} else {
...
var gensym_env26117 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env26117;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26118 = token;
var G__26118__$1 = (((G__26118 == null))?null:cljs.core.subs.call(null,G__26118,(1)));
var G__26118__$2 = (((G__26118__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26118__$1));
var G__26118__$3 = (((G__26118__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26118__$2));
var G__26118__$4 = (((G__26118__$3 == null))?null:cljs.core.symbol.call(null,G__26118__$3));
if((G__26118__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26118__$4);
}
})():(function (){var G__26119 = token;
var G__26119__$1 = (((G__26119 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26119));
if((G__26119__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26119__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26130,reader){
...
var eof = cljs.core.get.call(null,map__26131__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26137){
var G__26138 = cljs.core.first.call(null,seq26137);
var seq26137__$1 = cljs.core.next.call(null,seq26137);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26138,seq26137__$1);
});


//# sourceMappingURL=reader.js.map?rel=1525301022805
