...
return (new CustomEvent(event_name,(function (){var obj29647 = {"detail":data};
return obj29647;
})()));
} else {
...
var f = (function (){var pred__29654 = cljs.core._EQ_;
var expr__29655 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29654.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29655))){
return ((function (pred__29654,expr__29655){
return (function (p1__29648_SHARP_){
return console.warn(p1__29648_SHARP_);
});
;})(pred__29654,expr__29655))
} else {
if(cljs.core.truth_(pred__29654.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29655))){
return ((function (pred__29654,expr__29655){
return (function (p1__29649_SHARP_){
return console.debug(p1__29649_SHARP_);
});
;})(pred__29654,expr__29655))
} else {
if(cljs.core.truth_(pred__29654.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29655))){
return ((function (pred__29654,expr__29655){
return (function (p1__29650_SHARP_){
return console.error(p1__29650_SHARP_);
});
;})(pred__29654,expr__29655))
} else {
return ((function (pred__29654,expr__29655){
return (function (p1__29651_SHARP_){
return console.log(p1__29651_SHARP_);
});
;})(pred__29654,expr__29655))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29658){
...
var opts = map__29659__$1;
var eval_fn = cljs.core.get.call(null,map__29659__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29661_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29663,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1525301025127
