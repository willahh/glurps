...
return (new CustomEvent(event_name,(function (){var obj28924 = {"detail":data};
return obj28924;
})()));
} else {
...
var f = (function (){var pred__28931 = cljs.core._EQ_;
var expr__28932 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28931.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28932))){
return ((function (pred__28931,expr__28932){
return (function (p1__28925_SHARP_){
return console.warn(p1__28925_SHARP_);
});
;})(pred__28931,expr__28932))
} else {
if(cljs.core.truth_(pred__28931.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28932))){
return ((function (pred__28931,expr__28932){
return (function (p1__28926_SHARP_){
return console.debug(p1__28926_SHARP_);
});
;})(pred__28931,expr__28932))
} else {
if(cljs.core.truth_(pred__28931.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28932))){
return ((function (pred__28931,expr__28932){
return (function (p1__28927_SHARP_){
return console.error(p1__28927_SHARP_);
});
;})(pred__28931,expr__28932))
} else {
return ((function (pred__28931,expr__28932){
return (function (p1__28928_SHARP_){
return console.log(p1__28928_SHARP_);
});
;})(pred__28931,expr__28932))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28935){
...
var opts = map__28936__$1;
var eval_fn = cljs.core.get.call(null,map__28936__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28938_SHARP_);
});})(new_def))
);
...
return (function (p__28939){
var vec__28940 = p__28939;
var ky = cljs.core.nth.call(null,vec__28940,(0),null);
...
}catch (e28945){if((e28945 instanceof Error)){
var e = e28945;
return not_found;
} else {
throw e28945;
...
//# sourceMappingURL=utils.js.map?rel=1525289328239
