...
var o23132 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23132["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23133 = temp__5455__auto____$1;
return (o23133["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22244__auto__ = f;
return (o__22244__auto__["toString"]).call(o__22244__auto__);
} else {
return "";
}
}catch (e23134){var _ = e23134;
return "";
}});
...
try{var o__22244__auto___23136 = t;
(o__22244__auto___23136["cljs$lang$ctorPrWriter"]).call(o__22244__auto___23136,t,writer);
}catch (e23135){var __23137 = e23135;
}
...
var char_code = (function (){var o__22244__auto__ = (new String(char$));
return (o__22244__auto__["charCodeAt"]).call(o__22244__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22244__auto__ = String;
return (o__22244__auto__["fromCharCode"]).call(o__22244__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23138 = num_code;
switch (G__23138) {
case (1):
return (185);
...
var o__22244__auto__ = String;
return (o__22244__auto__["fromCharCode"]).call(o__22244__auto__,superscript_code);
});
/**
...
}catch (e23140){var _e__22251__auto__ = e23140;
return false;
}})())){
...
var vec__23141 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23141,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23144 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23144["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23145 = temp__5455__auto____$1;
return (o23145["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23148){
var vec__23149 = p__23148;
var ns_detector = cljs.core.nth.call(null,vec__23149,(0),null);
...
var G__23155 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23156 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23155;
remaining_tokens = G__23156;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23146){
var G__23147 = cljs.core.first.call(null,seq23146);
var seq23146__$1 = cljs.core.next.call(null,seq23146);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23147,seq23146__$1);
});
...
var vec__23160 = cljs.core.split_with.call(null,(function (p1__23159_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23159_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23160,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23160,(1),null);
...
var vec__23163 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23163,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23163,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23166 = cljs.core.rest.call(null,remaining_tokens);
var G__23167 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23166;
name_tokens = G__23167;
continue;
} else {
...
var vec__23170 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23170,(0),null);
var arity = cljs.core.nth.call(null,vec__23170,(1),null);
var vec__23173 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23173,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23173,(1),null);
var vec__23176 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23176,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23176,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23176,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23176,(3),null);
...
var vec__23182 = result;
var munged_ns = cljs.core.nth.call(null,vec__23182,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23182,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23182,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23182,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23182,(4),null);
var arity = cljs.core.nth.call(null,vec__23182,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23186 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23186,(0),null);
var args = cljs.core.nth.call(null,vec__23186,(1),null);
var vec__23189 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23189,(0),null);
var name = cljs.core.nth.call(null,vec__23189,(1),null);
...
var G__23192 = (arity + (1));
var G__23193 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23194){
var vec__23195 = p__23194;
var arity = cljs.core.nth.call(null,vec__23195,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23195,(1),null);
...
return cljs.core.get.call(null,arities,p1__23198_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23199_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23202){
var vec__23203 = p__23202;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23203,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23200){
...
var G__23209 = arg;
var G__23209__$1 = (((G__23209 instanceof cljs.core.Keyword))?G__23209.fqn:null);
switch (G__23209__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23211__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23211__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23211__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23211__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23212 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23212,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23212,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23212,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23212,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23212,(4),null);
var arity = cljs.core.nth.call(null,vec__23212,(5),null);
...
var o__22244__auto__ = f;
return (o__22244__auto__["getBasis"]).call(o__22244__auto__);
});
/**
...
}catch (e23216){var _e__22251__auto__ = e23216;
...
var G__23217 = (obj[cljs.core.first.call(null,path)]);
var G__23218 = cljs.core.rest.call(null,path);
obj = G__23217;
path = G__23218;
continue;
} else {
...
return (function (accum,p__23219){
var vec__23220 = p__23219;
var bit = cljs.core.nth.call(null,vec__23220,(0),null);
var protocol = cljs.core.nth.call(null,vec__23220,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23223){
...
var selector = cljs.core.nth.call(null,vec__23224,(2),null);
...
return (function (p__23228){
var vec__23229 = p__23228;
var munged_name = cljs.core.nth.call(null,vec__23229,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23229,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23229,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23227_SHARP_){
return (obj[cljs.core.first.call(null,p1__23227_SHARP_)]);
});})(name,sorted_matches,vec__23229,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1525301017755
