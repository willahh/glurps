...
var o23131 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23131["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23132 = temp__5455__auto____$1;
return (o23132["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22243__auto__ = f;
return (o__22243__auto__["toString"]).call(o__22243__auto__);
} else {
return "";
}
}catch (e23133){var _ = e23133;
return "";
}});
...
try{var o__22243__auto___23135 = t;
(o__22243__auto___23135["cljs$lang$ctorPrWriter"]).call(o__22243__auto___23135,t,writer);
}catch (e23134){var __23136 = e23134;
}
...
var char_code = (function (){var o__22243__auto__ = (new String(char$));
return (o__22243__auto__["charCodeAt"]).call(o__22243__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22243__auto__ = String;
return (o__22243__auto__["fromCharCode"]).call(o__22243__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23137 = num_code;
switch (G__23137) {
case (1):
return (185);
...
var o__22243__auto__ = String;
return (o__22243__auto__["fromCharCode"]).call(o__22243__auto__,superscript_code);
});
/**
...
}catch (e23139){var _e__22250__auto__ = e23139;
return false;
}})())){
...
var vec__23140 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23140,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23143 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23143["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23144 = temp__5455__auto____$1;
return (o23144["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___23151 = arguments.length;
var i__4500__auto___23152 = (0);
while(true){
if((i__4500__auto___23152 < len__4499__auto___23151)){
args__4502__auto__.push((arguments[i__4500__auto___23152]));

var G__23153 = (i__4500__auto___23152 + (1));
i__4500__auto___23152 = G__23153;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23147){
var vec__23148 = p__23147;
var ns_detector = cljs.core.nth.call(null,vec__23148,(0),null);
...
var G__23154 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23155 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23154;
remaining_tokens = G__23155;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23145){
var G__23146 = cljs.core.first.call(null,seq23145);
var seq23145__$1 = cljs.core.next.call(null,seq23145);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23146,seq23145__$1);
});
...
var vec__23159 = cljs.core.split_with.call(null,(function (p1__23158_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23158_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23159,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23159,(1),null);
...
var vec__23162 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23162,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23162,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23165 = cljs.core.rest.call(null,remaining_tokens);
var G__23166 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23165;
name_tokens = G__23166;
continue;
} else {
...
var vec__23169 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23169,(0),null);
var arity = cljs.core.nth.call(null,vec__23169,(1),null);
var vec__23172 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23172,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23172,(1),null);
var vec__23175 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23175,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23175,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23175,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23175,(3),null);
...
var vec__23181 = result;
var munged_ns = cljs.core.nth.call(null,vec__23181,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23181,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23181,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23181,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23181,(4),null);
var arity = cljs.core.nth.call(null,vec__23181,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23185 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23185,(0),null);
var args = cljs.core.nth.call(null,vec__23185,(1),null);
var vec__23188 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23188,(0),null);
var name = cljs.core.nth.call(null,vec__23188,(1),null);
...
var G__23191 = (arity + (1));
var G__23192 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23193){
var vec__23194 = p__23193;
var arity = cljs.core.nth.call(null,vec__23194,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23194,(1),null);
...
return cljs.core.get.call(null,arities,p1__23197_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23198_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___23205 = arguments.length;
var i__4500__auto___23206 = (0);
while(true){
if((i__4500__auto___23206 < len__4499__auto___23205)){
args__4502__auto__.push((arguments[i__4500__auto___23206]));

var G__23207 = (i__4500__auto___23206 + (1));
i__4500__auto___23206 = G__23207;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23201){
var vec__23202 = p__23201;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23202,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23199){
var G__23200 = cljs.core.first.call(null,seq23199);
var seq23199__$1 = cljs.core.next.call(null,seq23199);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23200,seq23199__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23210__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23210__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23210__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23210__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23211 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23211,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23211,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23211,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23211,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23211,(4),null);
var arity = cljs.core.nth.call(null,vec__23211,(5),null);
...
var o__22243__auto__ = f;
return (o__22243__auto__["getBasis"]).call(o__22243__auto__);
});
/**
...
}catch (e23215){var _e__22250__auto__ = e23215;
...
var G__23216 = (obj[cljs.core.first.call(null,path)]);
var G__23217 = cljs.core.rest.call(null,path);
obj = G__23216;
path = G__23217;
continue;
} else {
...
return (function (accum,p__23218){
var vec__23219 = p__23218;
var bit = cljs.core.nth.call(null,vec__23219,(0),null);
var protocol = cljs.core.nth.call(null,vec__23219,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23222){
var vec__23223 = p__23222;
var ns = cljs.core.nth.call(null,vec__23223,(0),null);
var name = cljs.core.nth.call(null,vec__23223,(1),null);
var selector = cljs.core.nth.call(null,vec__23223,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23228,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23228,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23228,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23226_SHARP_){
return (obj[cljs.core.first.call(null,p1__23226_SHARP_)]);
});})(name,sorted_matches,vec__23228,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1525289322129
