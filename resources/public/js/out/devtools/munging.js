...
var o22941 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22941["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22942 = temp__5455__auto____$1;
return (o22942["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__22053__auto___22945 = t;
(o__22053__auto___22945["cljs$lang$ctorPrWriter"]).call(o__22053__auto___22945,t,writer);
}catch (e22944){var __22946 = e22944;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22947 = num_code;
switch (G__22947) {
case (1):
return (185);
...
}catch (e22949){var _e__22060__auto__ = e22949;
return false;
}})())){
...
var vec__22950 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22950,(0),null);
...
var temp__5455__auto____$1 = (o22953["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22954 = temp__5455__auto____$1;
return (o22954["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___22961 = arguments.length;
var i__4500__auto___22962 = (0);
while(true){
if((i__4500__auto___22962 < len__4499__auto___22961)){
args__4502__auto__.push((arguments[i__4500__auto___22962]));

var G__22963 = (i__4500__auto___22962 + (1));
i__4500__auto___22962 = G__22963;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22957){
var vec__22958 = p__22957;
var ns_detector = cljs.core.nth.call(null,vec__22958,(0),null);
...
var G__22964 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22965 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22964;
remaining_tokens = G__22965;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22955){
var G__22956 = cljs.core.first.call(null,seq22955);
var seq22955__$1 = cljs.core.next.call(null,seq22955);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22956,seq22955__$1);
});
...
var vec__22969 = cljs.core.split_with.call(null,(function (p1__22968_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22968_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22969,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22969,(1),null);
...
var vec__22972 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22972,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22972,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22975 = cljs.core.rest.call(null,remaining_tokens);
var G__22976 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22975;
name_tokens = G__22976;
continue;
} else {
...
var vec__22979 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22979,(0),null);
var arity = cljs.core.nth.call(null,vec__22979,(1),null);
var vec__22982 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22982,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22982,(1),null);
var vec__22985 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22985,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22985,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22985,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22985,(3),null);
...
var vec__22991 = result;
var munged_ns = cljs.core.nth.call(null,vec__22991,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22991,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22991,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22991,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22991,(4),null);
var arity = cljs.core.nth.call(null,vec__22991,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22995 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22995,(0),null);
var args = cljs.core.nth.call(null,vec__22995,(1),null);
var vec__22998 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22998,(0),null);
var name = cljs.core.nth.call(null,vec__22998,(1),null);
...
var G__23001 = (arity + (1));
var G__23002 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23003){
var vec__23004 = p__23003;
var arity = cljs.core.nth.call(null,vec__23004,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23004,(1),null);
...
return cljs.core.get.call(null,arities,p1__23007_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23008_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23011){
var vec__23012 = p__23011;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23012,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23009){
var G__23010 = cljs.core.first.call(null,seq23009);
var seq23009__$1 = cljs.core.next.call(null,seq23009);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23010,seq23009__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23020__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23020__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23020__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23020__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23021 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23021,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23021,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23021,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23021,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23021,(4),null);
var arity = cljs.core.nth.call(null,vec__23021,(5),null);
...
}catch (e23025){var _e__22060__auto__ = e23025;
...
var G__23026 = (obj[cljs.core.first.call(null,path)]);
var G__23027 = cljs.core.rest.call(null,path);
obj = G__23026;
path = G__23027;
continue;
} else {
...
return (function (accum,p__23028){
var vec__23029 = p__23028;
var bit = cljs.core.nth.call(null,vec__23029,(0),null);
var protocol = cljs.core.nth.call(null,vec__23029,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23032){
var vec__23033 = p__23032;
var ns = cljs.core.nth.call(null,vec__23033,(0),null);
var name = cljs.core.nth.call(null,vec__23033,(1),null);
var selector = cljs.core.nth.call(null,vec__23033,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23038,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23038,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23038,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23036_SHARP_){
return (obj[cljs.core.first.call(null,p1__23036_SHARP_)]);
});})(name,sorted_matches,vec__23038,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1525376037257
