...
var len__4499__auto___37438 = arguments.length;
var i__4500__auto___37439 = (0);
while(true){
if((i__4500__auto___37439 < len__4499__auto___37438)){
args__4502__auto__.push((arguments[i__4500__auto___37439]));

var G__37440 = (i__4500__auto___37439 + (1));
i__4500__auto___37439 = G__37440;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq37435){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37436,G__37437,seq37435__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__37441_SHARP_){
return !((cljs.core.meta.call(null,p1__37441_SHARP_) == null));
})))){
...
var map__37442 = opts;
var map__37442__$1 = ((((!((map__37442 == null)))?(((((map__37442.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37442.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__37442):map__37442);
var markup_db = cljs.core.get.call(null,map__37442__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e37446){var _e__34465__auto__ = e37446;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e37448){var _e__34465__auto__ = e37448;
return false;
}}
})())){
...
var _STAR_current_state_STAR_37450 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__37451 = opts;
...
var markup_db = cljs.core.get.call(null,map__37451__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_37450;
}});
...
;
var temp__5455__auto___37455 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___37455)){
var managed_print_level_37456 = temp__5455__auto___37455;
var _STAR_print_level_STAR_37454_37457 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_37456;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_37454_37457,managed_print_level_37456,temp__5455__auto___37455,writer,opts,job_fn){
return (function (p1__37453_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__37453_SHARP_,null);
});})(_STAR_print_level_STAR_37454_37457,managed_print_level_37456,temp__5455__auto___37455,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_37454_37457;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1525299177610
