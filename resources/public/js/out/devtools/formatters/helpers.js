...
var G__23234 = devtools.prefs.pref.call(null,v);
v = G__23234;
continue;
} else {
return v;
...
}catch (e23237){var _e__22251__auto__ = e23237;
return false;
}})();
...
}catch (e23241){var _e__22251__auto__ = e23241;
return false;
}})();
...
}catch (e23243){var _e__22251__auto__ = e23243;
return false;
}}
}
});
...
var vec__23245 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__23245,(0),null);
var name = cljs.core.nth.call(null,vec__23245,(1),null);
...
return cljs.core.some.call(null,(function (p1__23248_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__23248_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1525295739621
