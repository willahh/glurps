...
var line = cljs.core.get.call(null,map__25851__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25851__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e25850){var _e = e25850;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___25853 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___25853)){
var seen_errors_25854 = temp__5455__auto___25853;
if(cljs.core.truth_(seen_errors_25854.has(self))){
} else {
seen_errors_25854.add(self);

var temp__5457__auto___25855 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___25855)){
var sense_25856 = temp__5457__auto___25855;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25856)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1525301021920
