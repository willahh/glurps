...
var file = cljs.core.get.call(null,map__41474__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__41474__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__41474__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e41473){var _e = e41473;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___41476 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___41476)){
var seen_errors_41477 = temp__5455__auto___41476;
if(cljs.core.truth_(seen_errors_41477.has(self))){
} else {
seen_errors_41477.add(self);

var temp__5457__auto___41478 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___41478)){
var sense_41479 = temp__5457__auto___41478;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_41479)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1525299184904
